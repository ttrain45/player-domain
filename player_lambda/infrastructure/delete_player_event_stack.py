...
class DeletePlayerEventHandlerStack(Stack):
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        ### Create Delete Player Lambda ###
        delete_player_event = python.PythonFunction(self, "DeletePlayerEventHandler",
                                                    entry="player_lambda/runtime",  # required
                                                    runtime=_lambda.Runtime.PYTHON_3_8,  # required
                                                    index="delete_player_event.py",  # optional, defaults to 'index.py'
                                                    handler="handler",
                                                    memory_size=256,
                                                    function_name="DeletePlayerEventHandler",
        ...
        delete_player_event.grant_invoke(principal)
        ...
        player_data_event_bus.grant_put_events_to(delete_player_event)
